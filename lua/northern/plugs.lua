...
P.bufferline = {
	BufferLineBackground                = { fg = C.snow.c0, bg = visible },
	BufferLineBuffer                    = { fg = C.snow.c0, bg = visible, },
	BufferLineBufferSelected            = { fg = C.frost.turquoise, bg = C.bg, bold = true, },
	BufferLineBufferVisible             = { fg = C.snow.c0, bg = visible, },
	BufferLineCloseButton               = { fg = C.snow.c0, bg = C.bg, },
	BufferLineCloseButtonSelected       = { fg = C.night.c3, bg = C.night.c0, },
	BufferLineCloseButtonVisible        = { fg = visible, bg = C.snow.c0, },
	BufferLineDuplicate                 = { fg = C.snow.c0, bg = visible, },
	BufferLineDuplicateSelected         = { fg = C.frost.turquoise, bg = C.bg, },
	BufferLineDuplicateVisible          = { fg = C.snow.c0, bg = visible, },
	BufferLineError                     = { fg = C.aurora.red, bg = visible, sp = C.aurora.red, },
	BufferLineErrorDiagnostic           = { fg = C.aurora.red, bg = visible, sp = C.aurora.red, },
	BufferLineErrorDiagnosticSelected   = { fg = C.aurora.red, bg = C.bg, sp = C.aurora.red, },
	BufferLineErrorDiagnosticVisible    = { fg = C.aurora.red, bg = visible, },
	BufferLineErrorSelected             = { fg = C.aurora.red, bg = C.bg, sp = C.aurora.red, },
	BufferLineErrorVisible              = { fg = C.aurora.red, bg = visible, },
	BufferLineFill                      = { fg = C.snow.c0, bg = C.bg, },
	BufferLineHint                      = { fg = C.frost.turquoise, sp = C.frost.turquoise, bg = visible, },
	BufferLineHintDiagnostic            = { fg = C.frost.turquoise, sp = C.frost.turquoise, bg = visible, },
	BufferLineHintDiagnosticSelected    = { fg = C.frost.turquoise, bg = C.bg, sp = C.frost.turquoise, },
	BufferLineHintDiagnosticVisible     = { fg = C.frost.turquoise, bg = visible, },
	BufferLineHintSelected              = { fg = C.frost.turquoise, bg = C.bg, sp = C.frost.turquoise, },
	BufferLineHintVisible               = { fg = C.frost.turquoise, bg = visible, },
	BufferLineInfo                      = { fg = C.frost.turquoise, sp = C.frost.turquoise, bg = visible, },
	BufferLineInfoDiagnostic            = { fg = C.frost.turquoise, sp = C.frost.turquoise, bg = visible, },
	BufferLineInfoDiagnosticSelected    = { fg = C.frost.turquoise, sp = C.frost.turquoise, bg = C.bg, },
	BufferLineInfoDiagnosticVisible     = { fg = C.frost.turquoise, bg = visible, },
	BufferLineInfoSelected              = { fg = C.frost.turquoise, bg = C.bg, sp = C.frost.turquoise, },
	BufferLineInfoVisible               = { fg = C.frost.turquoise, bg = visible, },
	BufferLineIndicatorSelected         = { fg = C.aurora.yellow, bg = C.bg, },
	BufferLineModified                  = { fg = C.frost.turquoise, bg = visible, },
	BufferLineModifiedSelected          = { fg = C.frost.turquoise, bg = C.bg, },
	BufferLineModifiedVisible           = { fg = C.frost.turquoise, bg = visible, },
	BufferLineNumbers                   = { fg = C.night.c3, bg = visible, },
	BufferLineNumbersSelected           = { fg = C.frost.turquoise, bg = C.bg, },
	BufferLineNumbersVisible            = { fg = C.night.c3, bg = visible, },
	BufferLineOffsetSeparator           = { fg = C.bg, bg = C.bg, },
	BufferLineSeparator                 = { fg = C.blend.blue, bg = visible, },
	BufferLineSeparatorSelected         = { fg = C.blend.blue, bg = C.bg, },
	BufferLineSeparatorVisible          = { fg = C.blend.blue, bg = visible, },
	BufferLineTab                       = { fg = C.snow.c0, bg = visible, },
	BufferLinePick                      = { fg = C.frost.sea, bg = visible, },
	BufferLinePickSelected              = { fg = C.frost.sea, bg = visible, },
	BufferLinePickVisible               = { fg = C.frost.sea, bg = visible, },
	BufferLineTabClose                  = { fg = C.snow.c0, bg = C.bg, },
	BufferLineTabSelected               = { fg = C.frost.turquoise, bg = C.bg, },
	BufferLineTabSeparator              = { fg = C.blend.blue, bg = visible, },
	...
	BufferLineWarning                   = { fg = C.aurora.yellow, sp = C.aurora.yellow, bg = visible, },
	BufferLineWarningDiagnostic         = { fg = C.aurora.yellow, sp = C.aurora.yellow, bg = visible, },
	BufferLineWarningDiagnosticSelected = { fg = C.aurora.yellow, bg = C.bg, sp = C.aurora.yellow, },
	BufferLineWarningDiagnosticVisible  = { fg = C.aurora.yellow, bg = visible, },
	BufferLineWarningSelected           = { fg = C.aurora.yellow, bg = C.bg, sp = C.aurora.yellow, },
	BufferLineWarningVisible            = { fg = C.aurora.yellow, bg = visible, },
}
