...
P.neo_tree         = {
	...
	NeoTreeEndOfBuffer        = { fg = C.night.c0, bg = C.none },                          --|hl-EndOfBuffer| override in Neo-tree window.
	NeoTreeExpander           = { fg = C.night.c2, bg = C.none },                          --Used for collapsed/expanded icons.
	NeoTreeFadeText1          = { fg = C.night.c3, bg = C.none },                          --Used for icons and names that are hidden on Windows.
	...
	NeoTreeGitDeleted         = { fg = C.aurora.orange, bg = C.none },                     --File name when the git status is deleted.
	...
	NeoTreeGitUntracked       = { fg = C.aurora.purple, bg = C.none, underdotted = true }, --File name when the git status is untracked.
...
P.barbecue         = {
	...
	barbecue_dirname                = { fg = C.frost.turquoise, bg = C.bg, bold = true },
