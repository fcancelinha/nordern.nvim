...
B.gui = {
	...
	CursorLineSign = { fg = C.aurora.yellow, bg = C.none },                            --	Like SignColumn when 'cursorline' is set for the cursor line.
	...
	FloatFooter    = { fg = C.none, bg = C.bg },                                       --	Footer of floating windows.
	...
	IncSearch      = { fg = C.night.c0, bg = C.frost.turquoise, blend = 10 },          --	'incsearch' highlighting; also used for the text replaced with ":s///c".
	...
	PmenuExtraSel  = { fg = C.bg, bg = C.frost.turquoise },                            --	Popup menu: Selected item "extra text".
	PmenuKind      = { fg = C.night.c3, bg = C.none },                                 --	Popup menu: Normal item "kind".
	PmenuKindSel   = { fg = C.bg, bg = C.frost.turquoise },                            --	Popup menu: Selected item "kind".
	PmenuSbar      = { fg = C.night.c1, bg = C.bg },                                   --	Popup menu: Scrollbar.
	PmenuSel       = { fg = C.night.c0, bg = C.frost.turquoise, blend = 1, bold = true }, --	Popup menu: Selected item.
	...
	-- Gui
	Menu           = { fg = C.fg, bg = C.none }, -- 	Current font, background and foreground colors of the menus. Also used for the toolbar. Applicable highlight arguments: font, guibg, guifg. hl-Scrollbar
	...
	Tooltip        = { fg = C.fg, bg = C.none }, -- 	Current font, background and foreground of the tooltips. Applicable highlight arguments: font, guibg, guifg.
}
...
B.syntax = {
	...
	Function       = { fg = C.frost.sea, bg = C.none },     -- italic funtion names
	...
	Special        = { fg = C.frost.sea, bg = C.none },     -- any special symbol
	SpecialChar    = { fg = C.aurora.yellow, bg = C.none }, -- special character in a constant
	SpecialComment = { fg = C.frost.turquoise, bg = C.none }, -- special things inside a comment
	...
	Type           = { fg = C.frost.sea, bg = C.none },     -- int, long, char, etc.
