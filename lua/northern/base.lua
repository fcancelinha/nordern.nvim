...
B.gui = {
    ...
    NonText        = { fg = C.night.c0, bg = C.bg },                --	'@' at the end of the window, characters from 'showbreak' and other characters that do not really exist in the text (e.g., ">" displayed when a double-wide character doesn't fit at the end of the line). See also hl-EndOfBuffer.
    ...
    StatusLine     = { fg = C.bg, bg = C.bg },                      --	Status line of current window.
    StatusLineNC   = { fg = C.bg, bg = C.bg },                      --	Status lines of not-current windows. Note: If this is equal to "StatusLine", Vim will use "^^^" in the status line of the current window.
    ...
    Whitespace     = { fg = C.night.c0, bg = C.bg, sp = C.none },   --	"nbsp", "space", "tab", "multispace", "lead" and "trail" in 'listchars'.
    ...
    lCursor        = { fg = C.night.c0, bg = C.bg },                --	Character under the cursor when language-mapping is used (see 'guicursor').
    --- Diff
