...
L.lsp = {
    ...
    ['@lsp.mod.async']                       = { fg = C.frost.sea, bg = C.none },
...
L.typescript = {
    ...
    ['@function.method.call.typescript']                  = { fg = C.frost.light_blue, bg = C.none },
    ...
    ['@lsp.mod.readonly.typescript']                      = { fg = C.frost.turquoise, bg = C.none },
    ['@lsp.type.class.typescript']                        = { fg = C.frost.sea, bg = C.none },
    ['@lsp.type.enumMember.typescript']                   = { fg = C.aurora.yellow, bg = C.none },
    ['@lsp.type.interface.typescript']                    = { fg = C.frost.sea, bg = C.none },
    ...
    ['@lsp.typemod.enumMember.readonly.typescript']       = { fg = C.frost.turquoise, bg = C.none },
    ...
    ['@lsp.typemod.interface.declaration.typescript']     = { fg = C.frost.turquoise, bg = C.none },
    ...
    ['@lsp.typemod.property.readonly.typescript']         = { fg = C.frost.turquoise, bg = C.none },
    ...
    ['@lsp.typemod.variable.readonly.typescript']         = { fg = C.frost.turquoise, bg = C.none },
    ['@punctuation.delimiter.typescript']                 = { fg = C.frost.light_blue, bg = C.none },
...
L.javascript = {
    ...
    ['@function.method.call.javascript']                   = { fg = C.frost.light_blue, bg = C.none },
    ...
    ['@lsp.mod.readonly.javascript']                       = { fg = C.frost.turquoise, bg = C.none },
    ...
    ['@lsp.typemod.property.readonly.javascript']          = { fg = C.frost.turquoise, bg = C.none },
    ...
    ['@lsp.typemod.variable.readonly.javascript']          = { fg = C.frost.turquoise, bg = C.none },
    ['@method.call.javascript']                            = { fg = C.frost.light_blue, bg = C.none },
    ['@parameter.javascript']                              = { fg = C.fg, bg = C.none },
...
L.markdown = {
    ...
    ['@markup.raw.markdown_inline']            = { fg = C.frost.turquoise, bg = C.none },
